...
{
    public enum chartType { PlusMinus, Freq, RelativeFreq, NormalizedFreq, FreqSubintervals };
    ...
    internal class ResizeableRectangle : PictureBox
    {
        ...
        public ResizeableRectangle(int x, int y, int width, int height, int attacks, int cornerSize, chartType ct, PictureBox pictureBox, int n = 1)
        {
        ...
        public void DrawChartOnBitmap()
        {
            using (Graphics g = Graphics.FromImage(pictureBox.Image))
            {
                ...
                if(this.ct == chartType.FreqSubintervals)
                {
                ...
                if (this.ct == chartType.PlusMinus) g.DrawLine(Pens.Red, rect.Left, HalfwayYPoint, rect.Right, HalfwayYPoint);
