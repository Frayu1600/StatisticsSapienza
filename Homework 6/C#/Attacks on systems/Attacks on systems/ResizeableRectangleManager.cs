...
namespace Attacks_on_systems
{
    ...
    internal class ResizeableRectangleManager
    {
        ...
        public void CreateResizeableRectangle(int x, int y, int _ATTACKS, int _ROWS, int _COLUMNS, int _CORNER_SIZE, chartType ct, int startS = 0, int sStep = 0, int sLevels = 10, int P = 0)
        {
            rrs.Add(new ResizeableRectangle(x, y, _ATTACKS, _ROWS, _COLUMNS, _CORNER_SIZE, ct, pictureBox, startS, sStep, sLevels, P));
        }
